#
#  Be sure to run `pod spec lint xxPodTest.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "xuxiuwu" => "165066126@qq.com" }
  # Or just: spec.author    = "xuxiuwu"
  # spec.authors            = { "xuxiuwu" => "165066126@qq.com" }
  # spec.social_media_url   = "https://twitter.com/xuxiuwu"
